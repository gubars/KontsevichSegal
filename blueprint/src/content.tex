...
\begin{proposition}[Parametrization and contractibility; KS Proposition 2.4]
  ...
  \texttt{QC}. Contractibility additionally waits on foundation~F1, a
  topology on $Q_{\mathbb C}(V)$, currently bundled inside
  \texttt{found:homogeneous-bundles} and separating out when that node is
  split.
\end{proposition}
