...
\begin{lemma}[The positive-definite retraction of $Q_{\mathbb C}(V)$; in-repo machinery]
  ...
  \lean{KontsevichSegal.Retraction.seg_arg, KontsevichSegal.Retraction.g0,
    ...
    KontsevichSegal.Retraction.g0_continuous}
  \leanok
...
\begin{proposition}[Contractibility; KS Proposition 2.4]
  ...
  The statement is formalized. $Q_{\mathbb C}(V)$ carries the topology induced along
...
\begin{proof}
  ...
  contraction of the convex positive-definite cone gives the result. What remains unformalized
  is the assembly: allowability of the homotopy at each $t$, joint $(t,g)$-continuity and the
  \texttt{Homotopy} packaging, and the endpoint contraction. KS instead derive
  contractibility from the fibre-bundle description of
  Proposition~\ref{prop:parametrization}, which this route does not prove; foundation~F2 is
  therefore still owed for that proposition.
\end{proof}
